"""Python code conventions loaded into agents that review or write Python."""
...
- Comments explain *why* — a non-obvious constraint, a workaround,
  a subtle invariant. Not what.
